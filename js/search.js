...
var searchFunc = function (path, searchId, contentId) {
  ...
  $.ajax({
    ...
    success: function (xmlResponse) {
      ...
      var datas = xmlResponse.map(function (item) {
        return {
          title: item.title,
        ...
        datas.forEach(function (data) {
          ...
          if (matches > 0) {
            ...
            if (indexContent >= 0) {
              ...
              dataTitle = dataTitle.replace(regS, function (keyword) {
                return "<em class=\"search-keyword\">" + keyword + "</em>";
              });
              searchResult.str = "<li><h2><a href='" + dataUrl + "' class='search-result-title'>" + dataTitle + "</a></h2>";
            }
            if (firstOccur >= 0) {
